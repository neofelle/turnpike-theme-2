...
<div class="col-md-4 left no-space logo" style="position: absolute;z-index: 10;">
...
<br class="clear">
<div class="container-fullscreen" style="position: absolute;z-index: 2 !important;width: 100%;border-bottom: 1px solid #afa7a7;height: 95px;">
	<div class="c-md-12 left no-space" style="">
		<nav id="nav" role="navigation">
			...
			?> 
			<ul class="clearfix menu-header" style="margin-bottom: 1px !important;    z-index: 34 !important;width: 100%;margin-top: 0px;">
